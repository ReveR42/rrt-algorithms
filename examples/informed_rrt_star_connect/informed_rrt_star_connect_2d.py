...
# create rrt_search
rrt = InformedRRTStarBidirectional(X, q, x_init, x_goal, max_samples, r, prc, rewire_count)
path = rrt.informed_rrt_star_bidirectional()

# plot
plot = Plot("informed_rrt_star_bid_2d")
